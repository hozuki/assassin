...
namespace Assassin.Native {
    partial class NativeMethods {
        ...
        private static class X64 {
            ...
            [DllImport(LibraryName, CallingConvention = AssConvention, CharSet = AssCharSet)]
            public static extern IntPtr ass_library_done(IntPtr library);

            [DllImport(LibraryName, CallingConvention = AssConvention, CharSet = AssCharSet)]
            public static extern void ass_set_fonts_dir(IntPtr library, [MarshalAs(UnmanagedType.LPStr)] [CanBeNull]
                string fontsDir);
            ...
            public static extern void ass_process_data(
                IntPtr track,
                [MarshalAs(UnmanagedType.LPStr)] [NotNull]
                string data,
                int size);
            ...
            private const string LibraryDir = "x64";
