...
namespace Assassin.Native {
    internal static partial class NativeMethods {
        ...
        public static void ass_set_message_cb(IntPtr library, [CanBeNull] MessageCallback callback, IntPtr userData) {
            if (Is64Bit) {
                X64.ass_set_message_cb(library, callback, userData);
            } else {
                X86.ass_set_message_cb(library, callback, userData);
        ...
        public static void ass_process_data(IntPtr track, [NotNull] string data, int size) {
            if (Is64Bit) {
        ...
        public static void ass_process_codec_private(IntPtr track, [NotNull] string data, int size) {
            if (Is64Bit) {
        ...
        public static void ass_process_chunk(IntPtr track, [NotNull] string data, int size, long timeCode, long duration) {
            if (Is64Bit) {
        ...
        public static IntPtr ass_read_file(IntPtr library, [NotNull] string fileName, [CanBeNull] string codePage) {
            if (Is64Bit) {
        ...
        public static IntPtr ass_read_memory(IntPtr library, IntPtr buffer, int bufferSize, [CanBeNull] string codePage) {
            if (Is64Bit) {
        ...
        public static int ass_read_styles(IntPtr track, [NotNull] string fileName, [CanBeNull] string codePage) {
            if (Is64Bit) {
        ...
        public static void ass_add_font(IntPtr library, [NotNull] string name, IntPtr data, int dataSize) {
            if (Is64Bit) {
